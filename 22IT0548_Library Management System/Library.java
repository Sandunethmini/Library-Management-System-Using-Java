...
public class Library {
    ...
    public void addNewBook() {
        ...
        if (bookIsExist(isbn)) { //check if book exists
            ...
            System.out.println("Book type\n :-press 1 for FictionBook\n :-press 2 for NonFictionBook");
            System.out.print("Enter type Option : ");
            String type = scanner.nextLine();
            switch (type) {//create book objects according to the book type
                case "1":
                    bookList.add(new FictionBook(title, author, isbn, true));//store book object in the book list
                    System.out.println("Book Added Successfully....\n\n");
                    break;
                case "2":
                    bookList.add(new NonFictionBook(title, author, isbn, true));//store book object in the book list
                    System.out.println("Book Added Successfully....\n\n");
                    break;
                default:
